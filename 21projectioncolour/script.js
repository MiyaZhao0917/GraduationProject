...
function drawReliefBackground() {
  ...
  // changed
  glow1.addColorStop(0, 'rgba(255,196,126,0.22)');
...
class ReliefPetal {
  constructor(index) {
    ...
    // changed
    this.palette = ['#f4e4bf', '#b6ffe8', '#9fd0ff', '#d6b5ff', '#84f5cf', '#fff1d0'];
...
function drawGazeToReliefTransform(state, p) {
  ...
  // make the white wash a bit darker but still create an open feeling
  ...
  wash.addColorStop(0.62, `rgba(255,176,105,${0.018 * open * settleFade})`);
  wash.addColorStop(1, 'rgba(0,0,0,0)');
...
function drawMorphingBackground(state, q) {
  ...
  // avoid last frame being too light
