...
// offscreen buffer used only for the anxiety2-relief blur layers
...
function drawA2SourceStageDissolve(state, p) {
  ...
  // blur is applied with p5's built-in filter(BLUR) on an offscreen buffer instead of drawingContext.filter, which is slower during this full-screen transition
